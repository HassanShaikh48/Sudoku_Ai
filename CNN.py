...
class CNN:
    ...
    def build_and_compile_model(self):
        ...
        #Adding a Max pooling layer to the scene
        self.model.add (tf.keras.layers.MaxPool2D() )
        # Adding the layer that has been flattened
        self.model.add (tf.keras.layers.Flatten() )
        # Adding the previously unseen layer
    ...
    '''The Train/Test dataset is loaded, the model is trained, and the model is evaluated with this function.
            In the end, it displays the accuracy achieved on the test set.'''
